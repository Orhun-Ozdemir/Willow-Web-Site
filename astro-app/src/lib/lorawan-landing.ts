...
export const LORAWAN_LANDING_COPY: Record<Locale, LandingCopy> = {
  en: {
    ...
    portfolioLead: "Descriptions and technical details shown here come from the maintained WillowSoft product catalog.",
  ...
  tr: {
    ...
    portfolioLead: "Buradaki açıklamalar ve teknik bilgiler WillowSoft'un yönetilen ürün kataloğundan gelir.",
  ...
  de: {
    ...
    portfolioLead: "Beschreibungen und technische Angaben stammen aus dem gepflegten WillowSoft-Produktkatalog.",
  ...
  fr: {
    ...
    portfolioLead: "Les descriptions et données techniques proviennent du catalogue produit WillowSoft maintenu.",
  ...
  es: {
    ...
    portfolioLead: "Las descripciones y especificaciones proceden del catálogo de productos mantenido por WillowSoft.",
  ...
  it: {
    ...
    portfolioLead: "Descrizioni e dati tecnici provengono dal catalogo prodotti WillowSoft gestito.",
  ...
  ar: {
    ...
    portfolioLead: "تأتي الأوصاف والبيانات الفنية من كتالوج منتجات WillowSoft المُدار.",
  ...
  ja: {
    ...
    portfolioLead: "説明と技術情報は、管理されているWillowSoft製品カタログを参照しています。",
