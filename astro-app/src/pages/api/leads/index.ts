...
export const POST: APIRoute = async ({ request, clientAddress }) => {
  try {
    ...
    const lead = {
      ...
      interest_type: body.interestType || body.projectType || body.subject || "",
    ...
    try {
      const mailData: LeadMailData = {
        ...
        serviceInterest: lead.service_interest, message: message, sourcePage: lead.source_page,
        locale: lead.locale,
